...
public:
	...
	{
		static UObject* Function = 0;
		if (!Function) Function = FindObject(L"SceneComponent.GetSocketLocation");
...
public:
	...
	{
		static UObject* Function = 0;
		if (!Function) Function = FindObject(L"SkinnedMeshComponent.GetNumBones");
	...
	{
		static UObject* Function = 0;
		if (!Function) Function = FindObject(L"SkinnedMeshComponent.GetBoneName");
	...
	{
		static UObject* Function = 0;
		if (!Function) Function = FindObject(L"SkinnedMeshComponent.GetBoneIndex");
	...
	{
		static UObject* Function = 0;
		if (!Function) Function = FindObject(L"SkinnedMeshComponent.GetSocketBoneName");
...
public:
	...
	{
		return *(float*)(this + 0x25C);
	}

	float MaxWalkSpeed()
	{
		return *(float*)(this + 0x248);
	}

	float MaxWalkSpeedCrouched()
	{
		return *(float*)(this + 0x24C);
	}

	float MaxFlySpeed()
	{
		return *(float*)(this + 0x254);
	}
};
...
public:
	...
	bool bJumped()
	{
		return *(bool*)(this + 0x19);
	}

	bool bReachedEnd()
	{
		return *(bool*)(this + 0x1A);
	}
...
public:
	...
	{
		return *(FZiplinePawnState**)(this + 0x2528);
	}

	float ZiplineJumpStrength() // float -> FCurveTableRowHandle
	{
		return *(float*)(this + 0x2598);
	}

	float ZiplineJumpDampening() // float -> FCurveTableRowHandle
	{
		return *(float*)(this + 0x2588);
	}

	float ZiplineSpeedFactor()
	{
		return *(float*)(this + 0x2624);
	}
